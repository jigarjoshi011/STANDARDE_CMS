      ...
      <div className="w-1/2 px-15px">
          <div className=" rounded-3xl bg-highlight-primary p-10">
            ...
            <div className="relative mt-70px flex justify-end">
              ...
              <svg className="w-11 fill-white" viewBox="0 0 46 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div  className="w-1/2 px-4">
      ...
      <div className="mt-16">
        <div className="border-l-4 border-card-third pl-5">
          <h5 className="font-medium text-xl text-white mb-2">AI Search </h5>
          <p className="text-base font-light text-white">Pizza ipsum dolor meat lovers buffalo. Hand pizza sauce meat extra. Pepperoni spinach hand green meatball deep.</p>
          <a href="#" className="text-card-third text-base font-normal flex gap-2 items-center mt-3">Learn More<span><svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M9.51989 0.479943C9.71516 0.675205 9.71516 0.991787 9.51989 1.18705L1.18656 9.52038C0.991299 9.71564 0.674717 9.71564 0.479454 9.52038C0.284192 9.32512 0.284192 9.00854 0.479454 8.81328L8.81279 0.479943C9.00805 0.284681 9.32463 0.284681 9.51989 0.479943Z" fill="#5540D6"/>
<path fill-rule="evenodd" clip-rule="evenodd" d="M0.333008 0.833496C0.333008 0.557354 0.556865 0.333496 0.833008 0.333496H9.16634C9.44248 0.333496 9.66634 0.557354 9.66634 0.833496V9.16683C9.66634 9.44297 9.44248 9.66683 9.16634 9.66683C8.8902 9.66683 8.66634 9.44297 8.66634 9.16683V1.3335H0.833008C0.556865 1.3335 0.333008 1.10964 0.333008 0.833496Z" fill="#5540D6"/>
</svg>
</span></a>
        </div>
        <div className="mt-8 pl-6">
          <h5 className="font-medium text-xl text-white/50 mb-2">Marketplace </h5>
          <p className="text-base font-light text-text-primary">Pizza ipsum dolor meat lovers buffalo. Hand pizza sauce meat extra. Pepperoni spinach hand green meatball deep.</p>
