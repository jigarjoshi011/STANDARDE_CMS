        ...
        <div className="flex flex-col space-y-6 sm:space-y-0 sm:flex-row sm:justify-between sm:items-start md:items-center">
          <div className="flex flex-col  space-y-4 md:space-y-9">
            ...
            <div className="flex space-x-4 md:space-x-6">
              ...
              >
                <svg className="w-5 h-5 md:w-8 md:h-8" viewBox="0 0 33 30" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M25.9894 0H31.0496L19.9946 12.7077L33 30H22.8153L14.8395 19.5123L5.71339 30H0.650118L12.4746 16.4077L0 0H10.4401L17.6496 9.58615L25.9864 0H25.9894ZM24.2135 26.9538H27.0174L8.91809 2.88615H5.90919L24.2135 26.9538Z" fill="white"/>
</svg>
              ...
              <a
                ...
                className="hover:text-gray-400 transition-colors duration-300"
              >
                <svg className="w-5 h-5 md:w-8 md:h-8" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M28.5477 0H3.51041C2.14233 0 0.947021 0.984375 0.947021 2.33638V27.4292C0.947021 28.7886 2.14233 30 3.51041 30H28.5403C29.9158 30 30.947 28.7806 30.947 27.4292V2.33638C30.9551 0.984375 29.9158 0 28.5477 0ZM10.2464 25.0065H5.94858V11.6437H10.2464V25.0065ZM8.24613 9.61205H8.21532C6.83988 9.61205 5.94925 8.58817 5.94925 7.30647C5.94925 6.00134 6.86332 5.00156 8.26957 5.00156C9.67582 5.00156 10.5363 5.99397 10.5671 7.30647C10.5664 8.58817 9.67582 9.61205 8.24613 9.61205ZM25.9535 25.0065H21.6557V17.7C21.6557 15.9496 21.0303 14.7536 19.4754 14.7536C18.2874 14.7536 17.5843 15.5571 17.2716 16.34C17.1544 16.6212 17.1229 17.0042 17.1229 17.3953V25.0065H12.8251V11.6437H17.1229V13.5033C17.7484 12.6127 18.7254 11.331 20.9988 11.331C23.82 11.331 25.9542 13.1906 25.9542 17.1998L25.9535 25.0065Z" fill="white"/>
              </svg>
              ...
              <a
                ...
                className="hover:text-gray-400 transition-colors duration-300"
              >
                <svg className="w-5 h-5 md:w-8 md:h-8" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15 9.4C18.0927 9.4 20.6 11.9072 20.6 15C20.6 18.0927 18.0927 20.6 15 20.6C11.9072 20.6 9.4 18.0927 9.4 15C9.4 13.98 9.67271 13.0236 10.1492 12.2M23.4 6.6C23.4 6.9866 23.0865 7.3 22.7 7.3C22.3135 7.3 22 6.9866 22 6.6M23.4 6.6C23.4 6.2134 23.0865 5.9 22.7 5.9C22.3135 5.9 22 6.2134 22 6.6M23.4 6.6H22M12.2 29H17.8C21.7204 29 23.6806 29 25.178 28.237C26.4951 27.566 27.566 26.4951 28.237 25.178C29 23.6806 29 21.7204 29 17.8V12.2C29 8.27964 29 6.31945 28.237 4.82207C27.566 3.50494 26.4951 2.43406 25.178 1.76296C23.6806 1 21.7204 1 17.8 1H12.2C8.27964 1 6.31945 1 4.82207 1.76296C3.50494 2.43406 2.43406 3.50494 1.76296 4.82207C1 6.31945 1 8.27964 1 12.2V17.8C1 21.7204 1 23.6806 1.76296 25.178C2.43406 26.4951 3.50494 27.566 4.82207 28.237C6.31945 29 8.27964 29 12.2 29Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
