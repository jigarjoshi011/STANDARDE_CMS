...
import ProductSlideImagehigh from "../../public/images/highlight-product.png";
import Retail from "../../public/images/hight-img-01.png";
import Sales from "../../public/images/sales-platforms.png";
  ...
  return (
    <section className="text-white py-10 lg:py-14 pb-8 xl:py-100px overflow-hidden">
      ...
      <div className="mx-0 swiper-products">
        ...
        >
          <SwiperSlide>
            <div className="bg-card-bg py-8 pb-0 rounded-20px md:rounded-20px lg:rounded-32px  overflow-hidden h-470px md:h-560px">
            ...
            <div className="bg-card-bg p-8 pb-0 rounded-20px md:rounded-32px  overflow-hidden h-470px md:h-560px">
              <div className="flex items-center justify-between">
                <div className="relative">
                  ...
                  <h5 className="text-xl font-semibold mt-1"> Retailer app.</h5>
                </div>
                <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center">
                  <svg
                    className="w-2 h-3.5 fill-white"
          ...
          <SwiperSlide>
            <div className="bg-card-bg  rounded-20px md:rounded-32px overflow-hidden h-470px md:h-560px">
          ...
          <SwiperSlide>
            <div className="bg-card-bg pb-0 rounded-20px md:rounded-32px h-470px md:h-560px  overflow-hidden">
              ...
              <div className="relative mt-16 mt-8 pl-8">
                <Image
                  src={Erp}
                  alt="ProductSlide"
                  className="mx-auto w-full h-full"
